# Threads 投稿文案（夜）— Google AI Edge Eloquent／オフライン音声 note 公開告知

関連記事: `note/20260407/2026-04-07-google-ai-edge-eloquent｜静かなリリースとオフライン音声のPM視点.md`（※公開後は「note 公開済み」と差し替え可）
...
静かなローンチに近い語り口や実験的アプリの文脈、オフライン訴求とクラウドオプション・ストアのラベルをセットで読む話、そして純オンデバイス／ハイブリッド／クラウドの責任分界を自社の音声UXに転用する、という整理にしています。
